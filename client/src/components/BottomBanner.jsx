...
const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
       <img alt="banner" className='w-full hidden md:block' src={assets.bottom_banner_image} />
       <img alt="banner" className="w-full md:hidden" src={assets.bottom_banner_image_sm}/>
